...
public class FrogRiver {
    public int solution(int X, int[] A) {
        HashSet<Integer> positionsCovered = new HashSet<>();
        ...
        for (int time = 0; time < A.length; time++) {
            ...
            if (positionsCovered.size() == X) {
                return time; // The earliest time when the frog can jump
            }
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Frog River Jump...."+ fr.solution(5, new int[] {1,3,1,4,2,3,5,4}));
    }
}
